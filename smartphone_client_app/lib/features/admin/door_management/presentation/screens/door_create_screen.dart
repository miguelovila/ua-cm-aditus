...
class DoorCreateScreen extends StatefulWidget {
  const DoorCreateScreen({super.key});

  @override
  State<DoorCreateScreen> createState() => _DoorCreateScreenState();
}
...
class _DoorCreateScreenState extends State<DoorCreateScreen> {
  ...
  void _submitForm() {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      context.read<DoorManagementBloc>().add(
            DoorManagementCreateRequested(request),
          );
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<DoorManagementBloc, DoorManagementState>(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Create Door')),
        body: Form(
          key: _formKey,
          child: ListView(
